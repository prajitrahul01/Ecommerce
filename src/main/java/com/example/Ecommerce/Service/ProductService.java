...
import com.example.Ecommerce.ExceptionHandler.IdException;
import com.example.Ecommerce.ExceptionHandler.ProductException;
import com.example.Ecommerce.ExceptionHandler.RestExceptionHandler;
...
//        }
    ...
    public Product getProductBydes(String des) {
        return productRepository.getProductBydescription(des);
    }
